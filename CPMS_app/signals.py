...
# def is_running_clearsessions():
#     return 'clearsessions' in sys.argv
...
#     if isinstance(instance, Session) or sender.__name__ == "Log":
#         return

#     user = get_current_user()
#     if user is None:
#         user = User.objects.get(pk=3)  # تعيين Admin افتراضي وقت الميجريشن
