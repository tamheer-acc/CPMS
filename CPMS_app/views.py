...
# ---------------------------
class AllInitiativeView(LoginRequiredMixin, InitiativePermissionMixin, RoleRequiredMixin, ListView): 
    '''
...
#  StrategicGoal View
# ---------------------------
class AllGoalsView(LoginRequiredMixin, RoleRequiredMixin, ListView):
    '''
